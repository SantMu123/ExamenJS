...
export class MyMainContent extends LitElement{
  ...
  render() {
    return html`
        <section id = "content">
          ...
          <my-middle-content></my-middle-content>
        </section>
    `
  }
...
customElements.define('my-main-content', MyMainContent)
...
export class MyMiddleContent extends LitElement{
